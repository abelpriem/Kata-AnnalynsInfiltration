...
public class AnnalynsInfiltrationTest {
    ...
    public void can_execute_fast_attack_if_knight_is_sleeping() {
        ...
        assertThat(AnnalynsInfiltration.canFastAttack(knightIsAwake), is(true));
    }
    ...
    public void cannot_execute_fast_attack_if_knight_is_awake() {
        ...
        assertThat(AnnalynsInfiltration.canFastAttack(knightIsAwake), is(false));
    }
    ...
    public void can_spy_if_everyone_but_prisoner_is_sleeping() {
        ...
        assertThat(AnnalynsInfiltration.canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake), is(true));
    }
    ...
    public void cannot_spy_if_everyone_is_sleeping() {
        ...
        boolean archerIsAwake = false;
        boolean prisonerIsAwake = false;
        assertThat(AnnalynsInfiltration.canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake), is(false));
    }
    ...
    public void cannot_signal_prisoner_if_archer_is_awake_and_prisoner_is_sleeping() {
        boolean archerIsAwake = true;
        boolean prisonerIsAwake = false;
        assertThat(AnnalynsInfiltration.canSignalPrisoner(archerIsAwake, prisonerIsAwake), is(false));
    }
    ...
    public void can_signal_prisoner_if_archer_is_sleeping_and_prisoner_is_awake() {
        boolean archerIsAwake = false;
        boolean prisonerIsAwake = true;
        assertThat(AnnalynsInfiltration.canSignalPrisoner(archerIsAwake, prisonerIsAwake), is(true));
    }
    ...
    public void cannot_release_prisoner_if_only_archer_is_asleep_and_pet_dog_is_absent() {
        ...
        assertThat(AnnalynsInfiltration.canFreePrisoner(knightIsAwake, archerIsAwake, prisonerIsAwake, petDogIsPresent),
                is(false));
    }
